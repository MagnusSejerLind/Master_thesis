%  funktion som kør main med funktionsinput som output dof og fuktionsoutput som RMSE
clc
% kør extraction_condnum.m først
...
hold on
for i = 1:dof
plot(RMSE,'.-k',LineWidth=0.5)
end
plot(RMSE_AI,'o-r',LineWidth=3)
grid
